...
CREATE TABLE public.categories (
    "categoryId" integer DEFAULT nextval('public.category_category_id_seq'::regclass) NOT NULL,
    name text NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE VIEW public.actor_info AS
 SELECT a."actorId",
    ...
    public.group_concat(DISTINCT ((c.name || ': '::text) || ( SELECT public.group_concat(f.title) AS group_concat
          ...
          WHERE ((fc_1."categoryId" = c."categoryId") AND (fa_1."actorId" = a."actorId"))
   ...
   FROM (((public.actors a
     ...
     LEFT JOIN public.categories c ON ((fc."categoryId" = c."categoryId")))
...
CREATE VIEW public.film_list AS
 SELECT films."filmId" AS fid,
   ...
   FROM ((((public.categories
     LEFT JOIN public."filmCategory" ON ((categories."categoryId" = "filmCategory"."categoryId")))
  ...
  GROUP BY films."filmId", films.title, films.description, categories.name, films."rentalRate", films.length, films.rating;
...
CREATE VIEW public.sales_by_film_category AS
 SELECT c.name AS categories,
   ...
   FROM (((((public.payments p
     ...
     JOIN public.categories c ON ((fc."categoryId" = c."categoryId")))
  GROUP BY c.name
...
--
-- Name: filmCategory film_category_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."filmCategory"
    ADD CONSTRAINT film_category_pkey PRIMARY KEY ("filmId", "categoryId");
...
--
-- Name: categories last_updated; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: filmCategory film_category_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."filmCategory"
    ADD CONSTRAINT film_category_category_id_fkey FOREIGN KEY ("categoryId") REFERENCES public.categories("categoryId") ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: filmCategory film_category_film_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."filmCategory"
    ADD CONSTRAINT film_category_film_id_fkey FOREIGN KEY ("filmId") REFERENCES public.films("filmId") ON UPDATE CASCADE ON DELETE RESTRICT;
